            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  required
                  min="1"
                  defaultValue={config?.totalTime ? config.totalTime / 60 : 5}
                />
              </div>
              <div>
                <Label htmlFor="yellowTime">
                ...
                <Input
                  ...
                  required
                  min="1"
                  defaultValue={config?.yellowTime ? config.yellowTime / 60 : 3}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  required
                  min="1"
                  defaultValue={config?.redTime ? config.redTime / 60 : 1}
                />
              </div>
            </div>
